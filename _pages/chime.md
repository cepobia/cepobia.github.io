...
---
<div pbi-resize="powerbi" pbi-resize-src="https://covid-biapp.azurewebsites.net/" pbi-resize-min-width="768" pbi-default-width="600px" pbi-default-height="488" pbi-resize-width="16" pbi-resize-height="8.5" pbi-resize-load-event="page-load" pbi-resize-header="true" pbi-resize-m-src="https://covid-biapp.azurewebsites.net/" pbi-resize-m-width="9" pbi-resize-m-height="16" style="position: relative;"><iframe frameborder="0" allowfullscreen="true"></iframe></div><script type="text/javascript">
